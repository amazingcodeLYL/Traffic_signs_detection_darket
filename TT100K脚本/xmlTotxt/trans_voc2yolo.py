...
# label标签对应json文件
label_json_path = '/home/dell/桌面/PycharmProjects/yolov3/data_processing/GTSRB_classes.json'
    ...
    for file in tqdm(file_names, desc="translate {} file...".format(train_val)):
        ...
        with open(os.path.join(save_txt_path, file + ".txt"), "w") as f:
            for index, obj in enumerate(data["object"]):
                ...
                info = [str(i) for i in [class_index, signs,colors,xcenter, ycenter, w, h]]
...
def create_class_txt(class_dict: dict):
    ...
    with open("/home/dell/桌面/PycharmProjects/yolov3/data/oneclasses.txt", "w") as w:
