...
filedir = "/home/dell/桌面/data_TT100K/annotations.json"
annos = json.loads(open(filedir).read())

trainIds =  getDirId("/home/dell/桌面/data_TT100K/TT100K_dataset/train/images/")
testIds =  getDirId("/home/dell/桌面/data_TT100K/TT100K_dataset/test/images/")
...
for id in ids:
    ...
    if len(annos["imgs"][id]["objects"]) > 0 and (id in trainIds):
        ...
        edit_xml(objects, id, dir = "/home/dell/桌面/data_TT100K/TT100K_dataset/train_xml")

    elif len(annos["imgs"][id]["objects"]) > 0 and (id in testIds):
        objects = annos["imgs"][id]["objects"]
        edit_xml(objects, id, dir = "/home/dell/桌面/data_TT100K/TT100K_dataset/test_xml")