...
import multilabel.dataset_read as dataset_read
from multilabel.dataset_read import color_attrs, direction_attrs, type_attrs
...
class Manager(object):
    ...
    def __init__(self, options, path):
        ...
        if self.options['is_resume']:
            ...
            self.net.load_state_dict(torch.load("/home/dell/桌面/PycharmProjects/Traffic-signs-multilabel/multilabel/checkpoints/epoch_86.pth"))
    ...
    def test_accuracy(self, data_loader, is_draw=False):
        ...
        print('=> prohibitory_acc: {:.3f}% , danger_acc: {:.3f}% ,mandatory_acc: {:.3f}% ,other_acc: {:.3f}% '.format(
            prohibitory_acc, danger_acc, mandatory_acc, other_acc))
