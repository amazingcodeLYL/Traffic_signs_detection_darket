...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/tt100k.data', help='*.data path')
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3.weights', help='initial weights path  yolov3-spp-ultralytics.pt')
