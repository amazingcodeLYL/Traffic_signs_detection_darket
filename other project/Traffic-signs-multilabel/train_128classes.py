...
wdir = 'weights/TT100K3' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best_ones.pt'
...
def train(hyp):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if not torch.isfinite(loss):
                print('WARNI.jpgNG: non-finite loss, ending training ', loss_items)
                return results
    ...
    if len(n):
        ...
        for f1, f2 in zip([wdir + 'last.pt', wdir + 'best_ones.pt', 'results.txt'], [flast, fbest, fresults]):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-spp_TT100K128.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='data/TT100K_128.data', help='*.data path')
    ...
    parser.add_argument('--adam', action='store_true', help='use weights/yolov3-spp-ultralytics.ptadam optimizer')
